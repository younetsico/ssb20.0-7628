...
class SecureBlackbox_SOAPSigner {
  ...
  public function __construct() {
    ...
    secureblackbox_soapsigner_register_callback($this->handle, 5, array($this, 'fireNotification'));
    secureblackbox_soapsigner_register_callback($this->handle, 6, array($this, 'fireResolveReference'));
    secureblackbox_soapsigner_register_callback($this->handle, 7, array($this, 'fireStoreCertificate'));
    secureblackbox_soapsigner_register_callback($this->handle, 8, array($this, 'fireStoreCRL'));
    secureblackbox_soapsigner_register_callback($this->handle, 9, array($this, 'fireStoreOCSPResponse'));
    secureblackbox_soapsigner_register_callback($this->handle, 10, array($this, 'fireTLSCertValidate'));
  }
  ...
  */
  public function doAddReference($targetxmlelement, $customid, $autogenerateid) {
    $ret = secureblackbox_soapsigner_do_addreference($this->handle, $targetxmlelement, $customid, $autogenerateid);
		$err = $ret;
...
public function VERSION() {
  ...
  */
  public function getKnownCertCount() {
    return secureblackbox_soapsigner_get($this->handle, 24 );
  }
 /**
  * The number of records in the KnownCert arrays.
  *
  ...
  */
  public function setKnownCertCount($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 24, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCertHandle($knowncertindex) {
    return secureblackbox_soapsigner_get($this->handle, 26 , $knowncertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownCertHandle($knowncertindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 26, $value , $knowncertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLCount() {
    return secureblackbox_soapsigner_get($this->handle, 27 );
  }
 /**
  * The number of records in the KnownCRL arrays.
  *
  ...
  */
  public function setKnownCRLCount($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 27, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLHandle($knowncrlindex) {
    return secureblackbox_soapsigner_get($this->handle, 29 , $knowncrlindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownCRLHandle($knowncrlindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 29, $value , $knowncrlindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPCount() {
    return secureblackbox_soapsigner_get($this->handle, 30 );
  }
 /**
  * The number of records in the KnownOCSP arrays.
  *
  ...
  */
  public function setKnownOCSPCount($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 30, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPHandle($knownocspindex) {
    return secureblackbox_soapsigner_get($this->handle, 32 , $knownocspindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownOCSPHandle($knownocspindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 32, $value , $knownocspindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getProxyUseProxy() {
    return secureblackbox_soapsigner_get($this->handle, 46 );
  }
 /**
  * Enables or disables proxy-driven connection.
  *
  ...
  */
  public function setProxyUseProxy($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 46, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getProxyUsername() {
    return secureblackbox_soapsigner_get($this->handle, 47 );
  }
 /**
  * Specifies the username credential for proxy authentication.
  *
  ...
  */
  public function setProxyUsername($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 47, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getReferenceCount() {
    return secureblackbox_soapsigner_get($this->handle, 48 );
  }
 /**
  * The number of records in the Reference arrays.
  *
  ...
  */
  public function setReferenceCount($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 48, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getReferenceUseXPathFilter2Transform($referenceindex) {
    return secureblackbox_soapsigner_get($this->handle, 64 , $referenceindex);
  }
 /**
  * Specifies whether XPath Filter 2.
  *
  ...
  */
  public function setReferenceUseXPathFilter2Transform($referenceindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 64, $value , $referenceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getReferenceUseXPathTransform($referenceindex) {
    return secureblackbox_soapsigner_get($this->handle, 65 , $referenceindex);
  }
 /**
  * Specifies whether XPath transform is included in transform chain.
  *
  ...
  */
  public function setReferenceUseXPathTransform($referenceindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 65, $value , $referenceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getReferenceXPathExpression($referenceindex) {
    return secureblackbox_soapsigner_get($this->handle, 66 , $referenceindex);
  }
 /**
  * Use this property to specify XPath expression for XPath transform of the reference.
  *
  ...
  */
  public function setReferenceXPathExpression($referenceindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 66, $value , $referenceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getReferenceXPathFilter2Expressions($referenceindex) {
    return secureblackbox_soapsigner_get($this->handle, 67 , $referenceindex);
  }
 /**
  * Use this property to specify XPointer expression(s) for XPath Filter 2.
  *
  ...
  */
  public function setReferenceXPathFilter2Expressions($referenceindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 67, $value , $referenceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getReferenceXPathFilter2Filters($referenceindex) {
    return secureblackbox_soapsigner_get($this->handle, 68 , $referenceindex);
  }
 /**
  * Use this property to specify XPointer filter(s) for XPath Filter 2.
  *
  ...
  */
  public function setReferenceXPathFilter2Filters($referenceindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 68, $value , $referenceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getReferenceXPathFilter2PrefixList($referenceindex) {
    return secureblackbox_soapsigner_get($this->handle, 69 , $referenceindex);
  }
 /**
  * Use this property to specify a prefix list for XPath Filter 2.
  *
  ...
  */
  public function setReferenceXPathFilter2PrefixList($referenceindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 69, $value , $referenceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getReferenceXPathPrefixList($referenceindex) {
    return secureblackbox_soapsigner_get($this->handle, 70 , $referenceindex);
  }
 /**
  * Use this property to specify a prefix list for XPath transform of the reference.
  *
  ...
  */
  public function setReferenceXPathPrefixList($referenceindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 70, $value , $referenceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getRevocationCheck() {
    return secureblackbox_soapsigner_get($this->handle, 71 );
  }
 /**
  * Specifies the kind(s) of revocation check to perform.
  *
  ...
  */
  public function setRevocationCheck($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 71, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSigningChainBytes($signingchainindex) {
    return secureblackbox_soapsigner_get($this->handle, 77 , $signingchainindex);
  }
  ...
  */
  public function getSigningChainHandle($signingchainindex) {
    return secureblackbox_soapsigner_get($this->handle, 78 , $signingchainindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setSigningChainHandle($signingchainindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 78, $value , $signingchainindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSClientCertBytes($tlsclientcertindex) {
    return secureblackbox_soapsigner_get($this->handle, 92 , $tlsclientcertindex);
  }
  ...
  */
  public function getTLSClientCertHandle($tlsclientcertindex) {
    return secureblackbox_soapsigner_get($this->handle, 93 , $tlsclientcertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setTLSClientCertHandle($tlsclientcertindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 93, $value , $tlsclientcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSServerCertBytes($tlsservercertindex) {
    return secureblackbox_soapsigner_get($this->handle, 95 , $tlsservercertindex);
  }
  ...
  */
  public function getTLSServerCertHandle($tlsservercertindex) {
    return secureblackbox_soapsigner_get($this->handle, 96 , $tlsservercertindex);
  }
  ...
  */
  public function getTLSECCurves() {
    return secureblackbox_soapsigner_get($this->handle, 100 );
  }
 /**
  * Defines the elliptic curves to enable.
  *
  ...
  */
  public function setTLSECCurves($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 100, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSForceResumeIfDestinationChanges() {
    return secureblackbox_soapsigner_get($this->handle, 101 );
  }
 /**
  * Whether to force TLS session resumption when the destination address changes.
  *
  ...
  */
  public function setTLSForceResumeIfDestinationChanges($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 101, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSPreSharedIdentity($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 102, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSRevocationCheck() {
    return secureblackbox_soapsigner_get($this->handle, 106 );
  }
 /**
  * Specifies the kind(s) of revocation check to perform.
  *
  ...
  */
  public function setTLSRevocationCheck($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 106, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSSSLOptions() {
    return secureblackbox_soapsigner_get($this->handle, 107 );
  }
 /**
  * Various SSL (TLS) protocol options, set of cssloExpectShutdownMessage 0x001 cssloOpenSSLDTLSWorkaround 0x002 cssloDisableKexLengthAlignment 0x004 cssloForceUseOfClientCertHashAlg 0x008 cssloAutoAddServerNameExtension 0x010 cssloAcceptTrustedSRPPrimesOnly 0x020 cssloDisableSignatureAlgorithmsExtension 0x040 cssloIntolerateHigherProtocolVersions 0x080 cssloStickToPrefCertHashAlg 0x100 .
  *
  ...
  */
  public function setTLSSSLOptions($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 107, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSTLSMode() {
    return secureblackbox_soapsigner_get($this->handle, 108 );
  }
 /**
  * Specifies the TLS mode to use.
  *
  ...
  */
  public function setTLSTLSMode($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 108, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSUseExtendedMasterSecret() {
    return secureblackbox_soapsigner_get($this->handle, 109 );
  }
 /**
  * Enables Extended Master Secret Extension, as defined in RFC 7627.
  *
  ...
  */
  public function setTLSUseExtendedMasterSecret($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 109, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSUseSessionResumption() {
    return secureblackbox_soapsigner_get($this->handle, 110 );
  }
 /**
  * Enables or disables TLS session resumption capability.
  *
  ...
  */
  public function setTLSUseSessionResumption($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 110, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSVersions() {
    return secureblackbox_soapsigner_get($this->handle, 111 );
  }
 /**
  * Th SSL/TLS versions to enable by default.
  *
  ...
  */
  public function setTLSVersions($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 111, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTrustedCertCount() {
    return secureblackbox_soapsigner_get($this->handle, 112 );
  }
 /**
  * The number of records in the TrustedCert arrays.
  *
  ...
  */
  public function setTrustedCertCount($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 112, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTrustedCertBytes($trustedcertindex) {
    return secureblackbox_soapsigner_get($this->handle, 113 , $trustedcertindex);
  }
  ...
  */
  public function getTrustedCertHandle($trustedcertindex) {
    return secureblackbox_soapsigner_get($this->handle, 114 , $trustedcertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setTrustedCertHandle($trustedcertindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 114, $value , $trustedcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getValidationLog() {
    return secureblackbox_soapsigner_get($this->handle, 115 );
  }
  ...
  */
  public function getXAdESForm() {
    return secureblackbox_soapsigner_get($this->handle, 116 );
  }
 /**
  * Specifies which form of XAdES should be produced.
  *
  ...
  */
  public function setXAdESForm($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 116, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getXAdESVersion() {
    return secureblackbox_soapsigner_get($this->handle, 117 );
  }
 /**
  * Specifies XAdES version.
  *
  ...
  */
  public function setXAdESVersion($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 117, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getNamespaceCount() {
    return secureblackbox_soapsigner_get($this->handle, 118 );
  }
 /**
  * The number of records in the Namespace arrays.
  *
  ...
  */
  public function setNamespaceCount($value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 118, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getNamespacePrefix($namespaceindex) {
    return secureblackbox_soapsigner_get($this->handle, 119 , $namespaceindex);
  }
 /**
  * A user-defined prefix value of a namespace.
  *
  ...
  */
  public function setNamespacePrefix($namespaceindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 119, $value , $namespaceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getNamespaceURI($namespaceindex) {
    return secureblackbox_soapsigner_get($this->handle, 120 , $namespaceindex);
  }
 /**
  * A user-defined URI value of a namespace.
  *
  ...
  */
  public function setNamespaceURI($namespaceindex, $value) {
    $ret = secureblackbox_soapsigner_set($this->handle, 120, $value , $namespaceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_soapsigner_get_last_error($this->handle));
    }
    return $ret;
