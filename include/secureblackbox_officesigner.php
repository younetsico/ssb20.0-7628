...
class SecureBlackbox_OfficeSigner {
  ...
  public function __construct() {
    ...
    secureblackbox_officesigner_register_callback($this->handle, 3, array($this, 'fireNotification'));
    secureblackbox_officesigner_register_callback($this->handle, 4, array($this, 'fireStoreCertificate'));
    secureblackbox_officesigner_register_callback($this->handle, 5, array($this, 'fireStoreCRL'));
    secureblackbox_officesigner_register_callback($this->handle, 6, array($this, 'fireStoreOCSPResponse'));
    secureblackbox_officesigner_register_callback($this->handle, 7, array($this, 'fireTLSCertValidate'));
  }
...
public function VERSION() {
  ...
  */
  public function getKnownCertCount() {
    return secureblackbox_officesigner_get($this->handle, 22 );
  }
 /**
  * The number of records in the KnownCert arrays.
  *
  ...
  */
  public function setKnownCertCount($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 22, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCertHandle($knowncertindex) {
    return secureblackbox_officesigner_get($this->handle, 24 , $knowncertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownCertHandle($knowncertindex, $value) {
    $ret = secureblackbox_officesigner_set($this->handle, 24, $value , $knowncertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLCount() {
    return secureblackbox_officesigner_get($this->handle, 25 );
  }
 /**
  * The number of records in the KnownCRL arrays.
  *
  ...
  */
  public function setKnownCRLCount($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 25, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLHandle($knowncrlindex) {
    return secureblackbox_officesigner_get($this->handle, 27 , $knowncrlindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownCRLHandle($knowncrlindex, $value) {
    $ret = secureblackbox_officesigner_set($this->handle, 27, $value , $knowncrlindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPCount() {
    return secureblackbox_officesigner_get($this->handle, 28 );
  }
 /**
  * The number of records in the KnownOCSP arrays.
  *
  ...
  */
  public function setKnownOCSPCount($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 28, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPHandle($knownocspindex) {
    return secureblackbox_officesigner_get($this->handle, 30 , $knownocspindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownOCSPHandle($knownocspindex, $value) {
    $ret = secureblackbox_officesigner_set($this->handle, 30, $value , $knownocspindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSignatureType($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 48, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSigningCertBytes() {
    return secureblackbox_officesigner_get($this->handle, 51 );
  }
  ...
  */
  public function getSigningCertHandle() {
    return secureblackbox_officesigner_get($this->handle, 52 );
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setSigningCertHandle($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 52, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getSigningChainBytes($signingchainindex) {
    return secureblackbox_officesigner_get($this->handle, 54 , $signingchainindex);
  }
  ...
  */
  public function getSigningChainHandle($signingchainindex) {
    return secureblackbox_officesigner_get($this->handle, 55 , $signingchainindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setSigningChainHandle($signingchainindex, $value) {
    $ret = secureblackbox_officesigner_set($this->handle, 55, $value , $signingchainindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSClientCertBytes($tlsclientcertindex) {
    return secureblackbox_officesigner_get($this->handle, 70 , $tlsclientcertindex);
  }
  ...
  */
  public function getTLSClientCertHandle($tlsclientcertindex) {
    return secureblackbox_officesigner_get($this->handle, 71 , $tlsclientcertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setTLSClientCertHandle($tlsclientcertindex, $value) {
    $ret = secureblackbox_officesigner_set($this->handle, 71, $value , $tlsclientcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSServerCertBytes($tlsservercertindex) {
    return secureblackbox_officesigner_get($this->handle, 73 , $tlsservercertindex);
  }
  ...
  */
  public function getTLSServerCertHandle($tlsservercertindex) {
    return secureblackbox_officesigner_get($this->handle, 74 , $tlsservercertindex);
  }
  ...
  */
  public function getTLSPreSharedKeyCiphersuite() {
    return secureblackbox_officesigner_get($this->handle, 82 );
  }
 /**
  * Defines the ciphersuite used for PSK (Pre-Shared Key) negotiation.
  *
  ...
  */
  public function setTLSPreSharedKeyCiphersuite($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 82, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSRenegotiationAttackPreventionMode() {
    return secureblackbox_officesigner_get($this->handle, 83 );
  }
 /**
  * Selects renegotiation attack prevention mechanism.
  *
  ...
  */
  public function setTLSRenegotiationAttackPreventionMode($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 83, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSRevocationCheck($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 84, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSUseExtendedMasterSecret() {
    return secureblackbox_officesigner_get($this->handle, 87 );
  }
 /**
  * Enables Extended Master Secret Extension, as defined in RFC 7627.
  *
  ...
  */
  public function setTLSUseExtendedMasterSecret($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 87, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSUseSessionResumption() {
    return secureblackbox_officesigner_get($this->handle, 88 );
  }
 /**
  * Enables or disables TLS session resumption capability.
  *
  ...
  */
  public function setTLSUseSessionResumption($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 88, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSVersions() {
    return secureblackbox_officesigner_get($this->handle, 89 );
  }
 /**
  * Th SSL/TLS versions to enable by default.
  *
  ...
  */
  public function setTLSVersions($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 89, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTrustedCertCount() {
    return secureblackbox_officesigner_get($this->handle, 90 );
  }
 /**
  * The number of records in the TrustedCert arrays.
  *
  ...
  */
  public function setTrustedCertCount($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 90, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTrustedCertBytes($trustedcertindex) {
    return secureblackbox_officesigner_get($this->handle, 91 , $trustedcertindex);
  }
  ...
  */
  public function getTrustedCertHandle($trustedcertindex) {
    return secureblackbox_officesigner_get($this->handle, 92 , $trustedcertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setTrustedCertHandle($trustedcertindex, $value) {
    $ret = secureblackbox_officesigner_set($this->handle, 92, $value , $trustedcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getValidationLog() {
    return secureblackbox_officesigner_get($this->handle, 93 );
  }
  ...
  */
  public function getXAdESForm() {
    return secureblackbox_officesigner_get($this->handle, 94 );
  }
 /**
  * Specifies which form of XAdES should be produced.
  *
  ...
  */
  public function setXAdESForm($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 94, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getXAdESVersion() {
    return secureblackbox_officesigner_get($this->handle, 95 );
  }
 /**
  * Specifies XAdES version.
  *
  ...
  */
  public function setXAdESVersion($value) {
    $ret = secureblackbox_officesigner_set($this->handle, 95, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_officesigner_get_last_error($this->handle));
    }
    return $ret;
