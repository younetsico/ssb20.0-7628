...
class SecureBlackbox_XAdESVerifier {
  ...
  public function __construct() {
    ...
    secureblackbox_xadesverifier_register_callback($this->handle, 3, array($this, 'fireNotification'));
    secureblackbox_xadesverifier_register_callback($this->handle, 4, array($this, 'fireReferenceValidated'));
    secureblackbox_xadesverifier_register_callback($this->handle, 5, array($this, 'fireResolveReference'));
    secureblackbox_xadesverifier_register_callback($this->handle, 6, array($this, 'fireRetrieveCertificate'));
    secureblackbox_xadesverifier_register_callback($this->handle, 7, array($this, 'fireRetrieveCRL'));
    secureblackbox_xadesverifier_register_callback($this->handle, 8, array($this, 'fireRetrieveOCSPResponse'));
    secureblackbox_xadesverifier_register_callback($this->handle, 9, array($this, 'fireSignatureFound'));
    secureblackbox_xadesverifier_register_callback($this->handle, 10, array($this, 'fireSignatureValidated'));
    secureblackbox_xadesverifier_register_callback($this->handle, 11, array($this, 'fireStoreCertificate'));
    secureblackbox_xadesverifier_register_callback($this->handle, 12, array($this, 'fireStoreCRL'));
    secureblackbox_xadesverifier_register_callback($this->handle, 13, array($this, 'fireStoreOCSPResponse'));
    secureblackbox_xadesverifier_register_callback($this->handle, 14, array($this, 'fireTimestampFound'));
    secureblackbox_xadesverifier_register_callback($this->handle, 15, array($this, 'fireTimestampValidated'));
    secureblackbox_xadesverifier_register_callback($this->handle, 16, array($this, 'fireTLSCertValidate'));
  }
...
public function VERSION() {
  ...
  */
  public function getKnownCertCount() {
    return secureblackbox_xadesverifier_get($this->handle, 51 );
  }
 /**
  * The number of records in the KnownCert arrays.
  *
  ...
  */
  public function setKnownCertCount($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 51, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCertHandle($knowncertindex) {
    return secureblackbox_xadesverifier_get($this->handle, 53 , $knowncertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownCertHandle($knowncertindex, $value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 53, $value , $knowncertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLCount() {
    return secureblackbox_xadesverifier_get($this->handle, 54 );
  }
 /**
  * The number of records in the KnownCRL arrays.
  *
  ...
  */
  public function setKnownCRLCount($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 54, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownCRLHandle($knowncrlindex) {
    return secureblackbox_xadesverifier_get($this->handle, 56 , $knowncrlindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownCRLHandle($knowncrlindex, $value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 56, $value , $knowncrlindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPCount() {
    return secureblackbox_xadesverifier_get($this->handle, 57 );
  }
 /**
  * The number of records in the KnownOCSP arrays.
  *
  ...
  */
  public function setKnownOCSPCount($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 57, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getKnownOCSPHandle($knownocspindex) {
    return secureblackbox_xadesverifier_get($this->handle, 59 , $knownocspindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setKnownOCSPHandle($knownocspindex, $value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 59, $value , $knownocspindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getOCSPCount() {
    return secureblackbox_xadesverifier_get($this->handle, 61 );
  }
  ...
  */
  public function getOCSPProducedAt($ocspindex) {
    return secureblackbox_xadesverifier_get($this->handle, 67 , $ocspindex);
  }
  ...
  */
  public function setProxyUseIPv6($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 80, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setProxyUseProxy($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 81, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getProxyUsername() {
    return secureblackbox_xadesverifier_get($this->handle, 82 );
  }
 /**
  * Specifies the username credential for proxy authentication.
  *
  ...
  */
  public function setProxyUsername($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 82, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getQualified() {
    return secureblackbox_xadesverifier_get($this->handle, 83 );
  }
  ...
  */
  public function getReferenceCount() {
    return secureblackbox_xadesverifier_get($this->handle, 84 );
  }
  ...
  */
  public function getReferenceUseXPathFilter2Transform($referenceindex) {
    return secureblackbox_xadesverifier_get($this->handle, 100 , $referenceindex);
  }
  ...
  */
  public function getReferenceUseXPathTransform($referenceindex) {
    return secureblackbox_xadesverifier_get($this->handle, 101 , $referenceindex);
  }
  ...
  */
  public function getReferenceXPathExpression($referenceindex) {
    return secureblackbox_xadesverifier_get($this->handle, 102 , $referenceindex);
  }
  ...
  */
  public function getReferenceXPathFilter2Expressions($referenceindex) {
    return secureblackbox_xadesverifier_get($this->handle, 103 , $referenceindex);
  }
  ...
  */
  public function getReferenceXPathFilter2Filters($referenceindex) {
    return secureblackbox_xadesverifier_get($this->handle, 104 , $referenceindex);
  }
  ...
  */
  public function getReferenceXPathFilter2PrefixList($referenceindex) {
    return secureblackbox_xadesverifier_get($this->handle, 105 , $referenceindex);
  }
  ...
  */
  public function getReferenceXPathPrefixList($referenceindex) {
    return secureblackbox_xadesverifier_get($this->handle, 106 , $referenceindex);
  }
  ...
  */
  public function setRevocationCheck($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 107, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketDNSTotalTimeout($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 140, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketIncomingSpeedLimit($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 141, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketLocalAddress($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 142, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketLocalPort($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 143, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketOutgoingSpeedLimit($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 144, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketTimeout($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 145, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setSocketUseIPv6($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 146, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSClientCertBytes($tlsclientcertindex) {
    return secureblackbox_xadesverifier_get($this->handle, 160 , $tlsclientcertindex);
  }
  ...
  */
  public function getTLSClientCertHandle($tlsclientcertindex) {
    return secureblackbox_xadesverifier_get($this->handle, 161 , $tlsclientcertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setTLSClientCertHandle($tlsclientcertindex, $value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 161, $value , $tlsclientcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSServerCertBytes($tlsservercertindex) {
    return secureblackbox_xadesverifier_get($this->handle, 163 , $tlsservercertindex);
  }
  ...
  */
  public function getTLSServerCertHandle($tlsservercertindex) {
    return secureblackbox_xadesverifier_get($this->handle, 164 , $tlsservercertindex);
  }
  ...
  */
  public function getTLSECCurves() {
    return secureblackbox_xadesverifier_get($this->handle, 168 );
  }
 /**
  * Defines the elliptic curves to enable.
  *
  ...
  */
  public function setTLSECCurves($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 168, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTLSForceResumeIfDestinationChanges() {
    return secureblackbox_xadesverifier_get($this->handle, 169 );
  }
 /**
  * Whether to force TLS session resumption when the destination address changes.
  *
  ...
  */
  public function setTLSForceResumeIfDestinationChanges($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 169, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSPreSharedIdentity($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 170, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSPreSharedKey($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 171, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSPreSharedKeyCiphersuite($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 172, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSRenegotiationAttackPreventionMode($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 173, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSRevocationCheck($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 174, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSSSLOptions($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 175, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSTLSMode($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 176, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSUseExtendedMasterSecret($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 177, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSUseSessionResumption($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 178, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTLSVersions($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 179, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function setTrustedCertCount($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 180, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTrustedCertBytes($trustedcertindex) {
    return secureblackbox_xadesverifier_get($this->handle, 181 , $trustedcertindex);
  }
  ...
  */
  public function getTrustedCertHandle($trustedcertindex) {
    return secureblackbox_xadesverifier_get($this->handle, 182 , $trustedcertindex);
  }
 /**
  * Allows to get or set a 'handle', a unique identifier of the underlying property object.
  *
  ...
  */
  public function setTrustedCertHandle($trustedcertindex, $value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 182, $value , $trustedcertindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getTSACertSubject() {
    return secureblackbox_xadesverifier_get($this->handle, 205 );
  }
  ...
  */
  public function getTSACertSubjectKeyID() {
    return secureblackbox_xadesverifier_get($this->handle, 206 );
  }
  ...
  */
  public function getTSACertSubjectRDN() {
    return secureblackbox_xadesverifier_get($this->handle, 207 );
  }
  ...
  */
  public function getTSACertValidFrom() {
    return secureblackbox_xadesverifier_get($this->handle, 208 );
  }
  ...
  */
  public function getTSACertValidTo() {
    return secureblackbox_xadesverifier_get($this->handle, 209 );
  }
  ...
  */
  public function getValidatedSigningTime() {
    return secureblackbox_xadesverifier_get($this->handle, 210 );
  }
  ...
  */
  public function getValidationLog() {
    return secureblackbox_xadesverifier_get($this->handle, 211 );
  }
  ...
  */
  public function getValidationMoment() {
    return secureblackbox_xadesverifier_get($this->handle, 212 );
  }
 /**
  * The time point at which signature validity is to be established.
  *
  ...
  */
  public function setValidationMoment($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 212, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getXAdESEnabled() {
    return secureblackbox_xadesverifier_get($this->handle, 213 );
  }
  ...
  */
  public function getXAdESForm() {
    return secureblackbox_xadesverifier_get($this->handle, 214 );
  }
  ...
  */
  public function getXAdESVersion() {
    return secureblackbox_xadesverifier_get($this->handle, 215 );
  }
 /**
  * Specifies XAdES version.
  *
  ...
  */
  public function setXAdESVersion($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 215, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getXMLElement() {
    return secureblackbox_xadesverifier_get($this->handle, 216 );
  }
 /**
  * Specifies the XML element containing the signature.
  *
  ...
  */
  public function setXMLElement($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 216, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getNamespaceCount() {
    return secureblackbox_xadesverifier_get($this->handle, 217 );
  }
 /**
  * The number of records in the Namespace arrays.
  *
  ...
  */
  public function setNamespaceCount($value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 217, $value );
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getNamespacePrefix($namespaceindex) {
    return secureblackbox_xadesverifier_get($this->handle, 218 , $namespaceindex);
  }
 /**
  * A user-defined prefix value of a namespace.
  *
  ...
  */
  public function setNamespacePrefix($namespaceindex, $value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 218, $value , $namespaceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
  ...
  */
  public function getNamespaceURI($namespaceindex) {
    return secureblackbox_xadesverifier_get($this->handle, 219 , $namespaceindex);
  }
 /**
  * A user-defined URI value of a namespace.
  *
  ...
  */
  public function setNamespaceURI($namespaceindex, $value) {
    $ret = secureblackbox_xadesverifier_set($this->handle, 219, $value , $namespaceindex);
    if ($ret != 0) {
      throw new Exception($ret . ": " . secureblackbox_xadesverifier_get_last_error($this->handle));
    }
    return $ret;
